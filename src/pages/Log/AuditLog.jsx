...
const AuditLog = () => {
    ...
    const buildQueryParams = () => {
        const params = {}
        if (searchTerm) params.userId = searchTerm
    ...
    const handleExportCSV = () => {
        ...
        const header = ['id','userId','username','action','type','description','createdAt']
