...
export default function Header({userData}){
    return (
        <header className="bg-white border-b border-gray-200 px-8 py-4 rounded-lg mt-2 mr-2">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 pl-4 border-l border-gray-200">
                <div className="w-10 h-10 bg-gradient-to-br from-orange-400 to-pink-400 rounded-full flex items-center justify-center text-white font-medium">
                  <img src={userData?.avatar} alt="EY" />
                </div>
                <div className="text-sm">
                  <div className="font-medium text-gray-900">{userData?.fullname || 'Unknown User'}</div>
                </div>
