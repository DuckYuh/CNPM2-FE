...
export default function FormData({open, setOpen}) {
  ...
  const handleSubmit = async() => {
    ...
    //console.log("ready for creating:", dataInput)
    try{
        const loadingToast = toast.loading('Deleting customer...')
        const res = await axios.post(`${base_url}/api/audit/activity`, dataInput)
        ...
        //alert("Fail")
        console.warn("End with Failure", err)
        toast.error("Fail to create new log")
    }
    finally{
